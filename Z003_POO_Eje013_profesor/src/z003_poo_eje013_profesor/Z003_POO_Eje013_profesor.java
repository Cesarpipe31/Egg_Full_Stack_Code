...
*/
package z003_poo_eje013_profesor;

import model.Curso;
import service.ServiceCurso;

public class Z003_POO_Eje013_profesor {

    public static void main(String[] args) {
        ServiceCurso sc = new ServiceCurso();
        Curso c1 = sc.crearCurso();        
        sc.imprimirEstudiante(c1);
        System.out.println("La ganancia semana es: " + sc.calcularGananciaSemanal(c1));                
    }
